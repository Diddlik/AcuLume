...
| Screen | What it does |
|---|---|
| **Sharpen** | Live preview with before / after / split view, zoom at fit · 100% · 200% with drag-to-pan, every parameter as a slider with an expandable before/after illustration, one-click export |
